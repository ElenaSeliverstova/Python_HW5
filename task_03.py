...
list_of_languages = ["Python","C#","Ruby","HTML","JAVA","JS"]
list_of_orded = [i for i in range(1,len(list_of_languages)+1)]

list_for_task = list(zip(list_of_orded,list_of_languages))
